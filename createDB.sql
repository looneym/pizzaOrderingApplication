...
<title>Colino's Pizza Parlour</title>
...
<body>
    ...
    <form  id="pizza-form" onSubmit="return validateInput();" name="theform" method="post" action="http://atlantis.cit.ie/displayvalues.php">
